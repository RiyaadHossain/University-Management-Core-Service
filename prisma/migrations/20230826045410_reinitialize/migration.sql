...
-- AddForeignKey
ALTER TABLE "students" ADD CONSTRAINT "students_academicSemeterId_fkey" FOREIGN KEY ("academicSemeterId") REFERENCES "academic_semesters"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
