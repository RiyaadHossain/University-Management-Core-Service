...
-- CreateIndex
CREATE UNIQUE INDEX "offered_course_class_schedules_id_key" ON "offered_course_class_schedules"("id");
...
-- AddForeignKey
ALTER TABLE "offered_course_class_schedules" ADD CONSTRAINT "offered_course_class_schedules_roodId_fkey" FOREIGN KEY ("roodId") REFERENCES "rooms"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
