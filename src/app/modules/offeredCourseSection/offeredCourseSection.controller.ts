...
const createOfferedCourseSection: RequestHandler = catchAsync(
  async (req, res) => {
    const result =
      await OfferedCourseSectionServices.createOfferedCourseSection(req.body);
...
const getOfferedCourseSections: RequestHandler = catchAsync(
  async (req, res) => {
    const options = pick(req.query, paginationFields);

    const result = await OfferedCourseSectionServices.getOfferedCourseSections(
      options
    );
...
const updateOfferedCourseSection: RequestHandler = catchAsync(
  async (req, res) => {
    const id = req.params.id;
...
const deleteOfferedCourseSection: RequestHandler = catchAsync(
  async (req, res) => {
    const id = req.params.id;
